rule test_normality:
    ...
    output:
        results=f"{RESULTS_DIR}/test_normality/{{dataset_id}}/normality_test_results.csv",
        summary=f"{RESULTS_DIR}/test_normality/{{dataset_id}}/normality_summary.csv",
    log:
        f"{LOGS_DIR}/test_normality/{{dataset_id}}.log",
    params:
